...
Category.getObject = function(obj){  
	    var cat = new Category(obj.title);
	    cat.title = obj.title;
        return cat;
};
...
(function(){
    ...
    Product.getObject = function(obj){  //funcion que devuelve un objeto Shop a partir del objeto literal
        var pro = new Product(obj.SerialNumber,obj.name, obj.price, obj.images);
        pro.SerialNumber = obj.SerialNumber;
        return pro;
    };
...
Shop.getObject = function(obj){  //funcion que devuelve un objeto Shop a partir del objeto literal
	var shop = new Shop(obj.cif,obj.name);
	shop.cif = obj.cif;
	return shop;
};
